...
export const DocumentUploadStep = ({ onComplete }: DocumentUploadStepProps) => {
  ...
  const analyzeDocumentQuality = async (
    file: File
  ...
  const processDocument = async () => {
    ...
    if (analysis.quality >= 60 && analysis.isGovernmentIssued) {
      const mockExtractedData = {
        ...
        documentNumber:
          analysis.documentType === "Passport" ? "P123456789" : "DL123456789",
        ...
        <CardContent className="space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              Our enhanced AI is analyzing document authenticity, template
              matching, quality assessment, and performing OCR extraction. This
              comprehensive analysis typically takes 15-20 seconds.
            </p>
          </div>
        </CardContent>
      </Card>
  ...
  return (
    <Card className="border-0 shadow-xl bg-white/90 backdrop-blur-sm">
      <CardHeader>
        ...
        <CardDescription>
          Upload a clear, high-quality photo of your government-issued ID (NIN,
      ...
      <CardContent className="space-y-6">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="mt-1 text-sm text-amber-700 space-y-1">
                <li>
                  • Government-issued ID only (NIN, Passport, Driver's License)
                </li>
        ...
        <Button onClick={processDocument} disabled={!file} className="w-full">
